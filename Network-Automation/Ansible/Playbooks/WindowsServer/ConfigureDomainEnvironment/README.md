...
## Useful Reference within this REPO
- [Azure-Serv-Deploy](https://github.com/Cinderblook/tacklebox/tree/main/Terraform/Azure/Azure-Serv-Deploy) Deplying this Ansible Script within an Azure Environment
- [vSphere-WinServ-Deployment](https://github.com/Cinderblook/tacklebox/tree/main/Terraform/vSphere/vSphere-WinServ-Deployment) Deplying this Ansible Script within an vSphere Environment
